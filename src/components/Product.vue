        ...
        <div class="">
          <div class="flex py-8 bg-white">
            <button @click="prevSlide">
              <svg
                ...
                viewBox="0 0 24 24"
                class="fill-current rotate-90 h-8 w-8 lg:h-8 lg:w-8 text-blue-800 cursor-pointer mr-auto"
                style=""
              >
                <path
                  fill-rule="evenodd"
            ...
            <div id="myModal" class="modal">
              ...
              <div
                class="flex justify-center align-items-center bg-white pb-6"
              ...
              >
                <template v-for="(slide, index) in slides" :key="index">
                  <img
                    ...
                    :class="{ thumbnailsActive: index === currentSlide }"
                    class="mx-4 w-16 tile"
                  />
                </template>
              </div>
              <div id="caption"></div>
            ...
            <div class="relative overflow-hidden">
              <div
                class="flex transition ease-in-out myImg"
                :style="{
            ...
            <button @click="nextSlide">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                class="fill-current rotate-90 h-8 w-8 lg:h-8 lg:w-8 text-blue-800 cursor-pointer ml-auto"
                style=""
              >
                <path
                  fill-rule="evenodd"
          ...
          <div class="flex flex-col py-6 pr-4">
            <div class="flex justify-between">
              ...
              <h2 class="text-green-600 text-sm" style="color: red">
                Hurry Limited Stock
              </h2>
            </div>
            <div class="flex flex-col">
              <h1 class="font-bold" style="color: black">
            ...
            <div class="flex border-t-4 mt-3">
              <ul class="list-none">
                <li class="mt-2 text-sm" style="color: black">
                  <strong>Sim:</strong> DUAL SIM
                </li>
                <li class="mt-3 text-sm" style="color: black">
                  <strong>Condition:</strong> LIKE NEW
                </li>
                <li class="mt-3 text-sm" style="color: black">
                  <strong>Colour:</strong> LAVANDER
                </li>
                <li class="mt-3 text-sm" style="color: black">
                  <strong>Network:</strong> UNLOCKED
                </li>
                <li class="mt-3 text-sm" style="color: black">
          ...
          <div class="flex px-3 py-8 bg-white">
                ...
                >
                  <template v-if="slide.type === 'image'">
                    <img
                      ...
                      :id="index"
                      class="w-80 h-80 object-contain"
                      @mouseover="showZoom(index)"
                      @mousemove="showZoom(index)"
                      @click="showModal1(index)"
                    />
                  </template>
            ...
            <button @click="nextSlide">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                class="fill-current rotate-90 h-4 w-4 lg:h-8 lg:w-8 text-blue-800 cursor-pointer ml-auto"
                style=""
              >
                <path
                  fill-rule="evenodd"
          ...
          <div class="flex justify-center align-items-center bg-white pb-6">
            <template v-for="(slide, index) in slides" :key="index">
              ...
              <div
                ...
                class="flex items-center mx-3 w-16"
                @click="goToSlide(index + 1)"
                :class="{ thumbnailsActive: index + 1 === currentSlide }"
              >
          ...
          <div class="flex justify-center mt-4">
            <template v-for="(slide, index) in slides" :key="index">
              ...
              <div
                ...
                v-else-if="slide.type === 'video'"
                :class="[
                  { playActive: index + 1 === currentSlide },
                  slide.icon,
                ]"
                @click="goToSlide(index + 1)"
              ></div>
      ...
      <div class="flex" style="background: white">
                ...
                >
                  <template v-if="slide.type === 'image'">
                    <img
                      ...
                      @mouseover="showZoom1(index)"
                      @mousemove="showZoom1(index)"
        ...
        <div class="flex basis-[23%] flex-col py-6 pr-4 pl-28">
          ...
          <div class="flex flex-col">
            ...
            <h1 class="font-bold pb-10" style="color: black">
              Samsung galaxy S23 Plus 5G
            </h1>
          </div>
          <div
            class="flex justify-center align-items-center pb-6"
  ...
  methods: {
    ...
    nextSlideModal() {
      this.currentSlideModal =
        this.currentSlideModal < this.totalSlides
          ? this.currentSlideModal + 1
          : 1;
    },
    prevSlideModal() {
